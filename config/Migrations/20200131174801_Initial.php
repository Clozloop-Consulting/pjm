...
class Initial extends AbstractMigration
{
    public function up()
    {
        ...
        $this->table('account_sub_shares', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'integer', [
                'autoIncrement' => true,
                'default' => null,
                'limit' => 10,
...
4-represented',
        ...
        $this->table('journal_type_subs', ['id' => false, 'primary_key' => ['id']])
            ...
            ->addColumn('share_percentage', 'decimal', [
                'default' => '0',
                'limit' => 5,
                'null' => true,
                'precision'=>30,
        ...
        $this->table('journal_temps', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'integer', [
                'autoIncrement' => true,
                'default' => null,
                'limit' => 10,
...
2-audited',
            ...
            ->addColumn('financial_year_next', 'string', [
                'default' => null,
                'limit' => 100,
                'null' => true,
            ])
    ...
    {
        $this->dropTable('account_sub_shares');
